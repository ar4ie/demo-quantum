...
namespace Quantum {
  ...
  public unsafe partial struct Movement : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 7687;
        hash = hash * 31 + LookRotationSpeed.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FP.Serialize(&p->LookRotationSpeed, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Portal : Quantum.IComponent {
    public const Int32 SIZE = 32;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    [Tooltip("Target arena name")]
    public QString32 ArenaName;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 1373;
        hash = hash * 31 + ArenaName.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (Portal*)ptr;
        Quantum.QString32.Serialize(&p->ArenaName, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct SpawnPoint : Quantum.IComponentSingleton {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.Portal>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Portal>();
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.Portal), Quantum.Portal.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 6)
        ...
        .Add<Quantum.Portal>(Quantum.Portal.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.SpawnPoint>(Quantum.SpawnPoint.Serialize, null, null, ComponentFlags.Singleton)
        .Finish();
    }
    [Preserve()]
