...
namespace Quantum.Prototypes {
  ...
  public unsafe partial class MovementPrototype : ComponentPrototype<Quantum.Movement> {
    ...
    public void Materialize(Frame frame, ref Quantum.Movement result, in PrototypeMaterializationContext context = default) {
        result.LookRotationSpeed = this.LookRotationSpeed;
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.Portal))]
  public unsafe partial class PortalPrototype : ComponentPrototype<Quantum.Portal> {
    [MaxStringByteCount(30, "Unicode")]
    [Tooltip("Target arena name")]
    public string ArenaName;
    partial void MaterializeUser(Frame frame, ref Quantum.Portal result, in PrototypeMaterializationContext context);
    public override Boolean AddToEntity(FrameBase f, EntityRef entity, in PrototypeMaterializationContext context) {
        Quantum.Portal component = default;
        Materialize((Frame)f, ref component, in context);
        return f.Set(entity, component) == SetResult.ComponentAdded;
    }
    public void Materialize(Frame frame, ref Quantum.Portal result, in PrototypeMaterializationContext context = default) {
        PrototypeValidator.AssignQString(this.ArenaName, 32, in context, out result.ArenaName);
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
